...
insert into reservas (id_usuario, id_pista, fecha_inicio, fecha_fin, fecha_realizacion, tipo, notas)
values (1, 1, '2012/05/14 10:30:00', '2012/05/14 12:00:00', now(), 0, '');
insert into reservas (id_usuario, id_pista, fecha_inicio, fecha_fin, fecha_realizacion, tipo, notas)
values (1, 1, '2012/05/13 12:00:00', '2012/05/13 14:30:00', now(), 0, '');
