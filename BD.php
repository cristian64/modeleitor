...
class BD
{
	...
	public static function conectar()
	{
		...
		{
			Logger::error("<BD::conectar> No se pudo conectar al servidor de la base de datos.");
			$conexion = NULL;
		}

		if (!mysql_select_db(self::$nombreBd,$conexion))
		{
			Logger::error("<BD::conectar> No se pudo seleccionar la base de datos.");
			$conexion = NULL;
		}
	 ...
	 */
	public static function begin($conexion)
	{
		if ($conexion != NULL)
	 ...
	 * @return resource Resultado de la sentencia.
	 */
	public static function commit($conexion)
	{
		if ($conexion != NULL)
	 ...
	 * @return resource Resultado de la sentencia.
	 */
	public static function rollback($conexion)
	{
		if ($conexion != NULL)
